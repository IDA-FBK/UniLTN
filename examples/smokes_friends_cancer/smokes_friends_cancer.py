...
g_and = 0.9
And = ltn.Wrapper_Connective(ltn.fuzzy_ops.UniNormOperator(g=g_and, t_norm=ltn.fuzzy_ops.And_Prod, s_norm=ltn.fuzzy_ops.Or_ProbSum))
And = ltn.Wrapper_Connective(ltn.fuzzy_ops.And_Prod())
Or = ltn.Wrapper_Connective(ltn.fuzzy_ops.Or_ProbSum())
Implies = ltn.Wrapper_Connective(ltn.fuzzy_ops.Implies_QL(stable=True))
Forall = ltn.Wrapper_Quantifier(ltn.fuzzy_ops.Aggreg_pMeanError(p=2),semantics="forall")
Exists = ltn.Wrapper_Quantifier(ltn.fuzzy_ops.Aggreg_pMean(p=6),semantics="exists")
#Forall = ltn.Wrapper_Quantifier(ltn.fuzzy_ops.UninormQuantifier(g=0.1),semantics="forall")
Exists = ltn.Wrapper_Quantifier(ltn.fuzzy_ops.UninormQuantifier(g=0.8),semantics="exists")
