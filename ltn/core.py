...
class Predicate(_Model):
    ...
    def FromLogits(cls, logits_model: tf.keras.Model, activation_function: str, 
        ...
        if activation_function == "sigmoid":
            predicate = cls(SigmoidTfModel(logits_model, with_class_indexing=with_class_indexing, **kwargs))
...
class Function(_Model):
    ...
    def MLP(cls: Function, 
        ...
        flat_outputs = layers.Dense(output_nodes.numpy())(hidden)
...
class SigmoidTfModel(tf.keras.Model):
